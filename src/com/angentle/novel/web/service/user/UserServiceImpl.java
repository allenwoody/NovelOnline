package com.angentle.novel.web.service.user;
...
import com.angentle.novel.web.dao.UserMapper;
...
import com.angentle.novel.web.model.RoleExample.Criteria;
...
public class UserServiceImpl extends GenericServiceImpl<User, String> implements UserService {
	...
	public List<User> selectBySearching(Page<User> page, User model, String keyword) {
		UserExample example = new UserExample();
		 com.angentle.novel.web.model.UserExample.Criteria criteria = example.createCriteria();
		criteria.andIsValidEqualTo(EnumBool.YES.getCode());
...
//		}
		...
		com.angentle.novel.web.model.UserExample.Criteria criteria2 = example.createCriteria();
